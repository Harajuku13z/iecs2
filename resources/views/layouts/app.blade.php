                    ...
                    @foreach($staticPagesMenu as $staticPage)
                        ...
                        @if($hasSubMenu)
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle {{ request()->is('page/' . $staticPage->slug) || request()->is('page/' . $staticPage->slug . '*') ? 'active' : '' }}" 
                                   href="#" 
                                   role="button" 
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item {{ request()->is('page/' . $staticPage->slug) ? 'active' : '' }}" 
                                           href="{{ route('static-page.show', $staticPage->slug) }}">
                                            {{ $staticPage->menu_nom }}
                                        </a>
                                    </li>
                                    ...
                                    @foreach($subMenuItems as $subItem)
                                        <li>
                                            <a class="dropdown-item {{ request()->is('page/' . $subItem->slug) ? 'active' : '' }}" 
                                               href="{{ route('static-page.show', $subItem->slug) }}">
                                                {{ $subItem->menu_nom }}
                                            </a>
                                        </li>
                                    @endforeach
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('page/' . $staticPage->slug) ? 'active' : '' }}" 
                                   href="{{ route('static-page.show', $staticPage->slug) }}">
                                    {{ $staticPage->menu_nom }}
                                </a>
                            </li>
